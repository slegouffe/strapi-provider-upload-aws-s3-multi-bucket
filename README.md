# strapi-provider-upload-aws-s3-multi-bucket

## How-to
This is a fork of official @strapi/provider-upload-aws-s3 plugin that allows the use of multiple buckets, by calling the following new method in provider : 
